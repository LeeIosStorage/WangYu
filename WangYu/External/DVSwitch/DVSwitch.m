...
//    [self.layer setBorderColor:UIColorToRGB(0xadadad).CGColor];
...
//        label.adjustsLetterSpacingToFitWidth = YES;
    ...
    [self.sliderView.layer setCornerRadius:4.0];
    [self.sliderView.layer setBorderWidth:0.5]; //边框宽度
    [self.sliderView.layer setBorderColor:UIColorToRGB(0xadadad).CGColor];//边框颜色
