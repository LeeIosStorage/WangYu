...
- (void)readResponseHeaders
{
	...
	if ([self useCookiePersistence]) {
		...
		[[NSHTTPCookieStorage sharedHTTPCookieStorage] setCookies:newCookies forURL:[[self url] absoluteURL] mainDocumentURL:nil];
...
+ (void)registerForNetworkReachabilityNotifications
{
	[[LSReachability reachabilityForInternetConnection] startNotifier];
...
{
	return ([[LSReachability reachabilityForInternetConnection] currentReachabilityStatus] == ReachableViaWWAN);	
}
